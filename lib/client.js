...
`;
		...
		const ICONS = {
			...
			check: [(0, react.createElement)("path", {
				key: 0,
				d: "M20 6 9 17l-5-5"
			})],
			pen: [(0, react.createElement)("path", {
				key: 0,
				d: "M12 20h9"
			}), (0, react.createElement)("path", {
				key: 1,
			...
			close: [(0, react.createElement)("path", {
				key: 0,
				d: "M18 6 6 18"
			}), (0, react.createElement)("path", {
				key: 1,
		...
		function errorOf(result, fallback) {
			return result !== null && typeof result === "object" && typeof result.error === "string" ? result.error : fallback;
		}
		...
		*/
		function GitBranchBadge(props) {
			...
			const [rowAction, setRowAction] = (0, react.useState)(null);
			const [renameDraft, setRenameDraft] = (0, react.useState)("");
			const workspace = props.useWorkspaces((s) => s.items).find((w) => w.sessionIds.includes(props.sessionId));
			const workspacePath = workspace === void 0 ? void 0 : workspace.path;
			(0, react.useEffect)(() => {
			...
			const chipLabel = state.phase === "ready" ? state.current ?? "detached" : state.phase === "loading" ? "" : state.phase === "notGit" ? "非 Git" : "!";
			const chipTitle = state.phase === "ready" ? state.dirty ? workspacePath + "（当前分支 " + (state.current ?? "detached") + "，有未提交修改）" : workspacePath + "（当前分支 " + (state.current ?? "detached") + "）" : state.phase === "notGit" ? workspacePath + "（不是 Git 仓库）" : workspacePath;
			const chip = (0, react.createElement)("button", {
				type: "button",
				className: "gb-chip",
				title: chipTitle,
				"aria-label": "Git 分支",
				...
				chipLabel !== "" && (0, react.createElement)("span", {
					key: "n",
					className: "gb-name"
				}, chipLabel),
				state.phase === "ready" && state.dirty === true ? (0, react.createElement)("span", {
					key: "d",
					className: "gb-dot",
					title: "有未提交修改"
				}) : null
			]);
			if (!open) return (0, react.createElement)("div", { className: "gb-root" }, chip);
			const head = (0, react.createElement)("div", { className: "gb-head" }, [(0, react.createElement)("span", {
				key: "t",
				className: "gb-title"
			}, "分支"), (0, react.createElement)("button", {
				key: "x",
				type: "button",
				className: "gb-close",
				"aria-label": "关闭",
			...
			let body;
			if (state.phase === "error") body = (0, react.createElement)("div", { className: "gb-error" }, String(state.message));
			else if (state.phase === "notGit") body = (0, react.createElement)("div", { className: "gb-muted" }, "该文件夹不是 Git 仓库");
			else if (state.phase === "loading") body = (0, react.createElement)("div", { className: "gb-muted" }, "读取中…");
			else {
				const items = state.branches.map((branch) => {
					const current = branch === state.current;
					const isBusy = busy === branch;
					if (rowAction !== null && rowAction.branch === branch && rowAction.mode === "rename") return (0, react.createElement)("div", {
						key: branch,
						className: "gb-item gb-confirm-row"
					}, [
					...
					if (rowAction !== null && rowAction.branch === branch && rowAction.mode === "delete") return (0, react.createElement)("div", {
						key: branch,
						className: "gb-item gb-confirm-row"
					}, [(0, react.createElement)("span", {
						key: "t",
						className: "gb-confirm"
					}, "删除分支 " + branch + "？"), (0, react.createElement)("span", {
						key: "ops",
						className: "gb-row-op"
					}, [(0, react.createElement)("button", {
						key: "ok",
						type: "button",
						className: "gb-op gb-op-danger",
						disabled: isBusy,
						onClick: () => {
							deleteBranch(branch);
						}
					}, isBusy ? "…" : "删除"), (0, react.createElement)("button", {
						key: "no",
						type: "button",
						className: "gb-op",
						disabled: isBusy,
					...
					return (0, react.createElement)("div", {
						...
						onKeyDown: (e) => {
							if (e.key === "Enter") switchBranch(branch);
						}
					}, [
						(0, react.createElement)("span", {
							key: "c",
							className: "gb-check"
						}, current ? (0, react.createElement)(Icon, {
							name: "check",
							size: 12
						}) : null),
						(0, react.createElement)("span", { key: "b" }, branch),
						busy === branch ? (0, react.createElement)("span", {
							key: "w",
							className: "gb-muted gb-spin"
						}, (0, react.createElement)(Icon, {
							name: "refresh",
							size: 12
						})) : null,
				...
				const extra = [];
				if (state.current === null) extra.push((0, react.createElement)("div", {
					key: "det",
					className: "gb-muted"
				}, "HEAD 处于游离状态"));
				if (notice !== null) extra.push((0, react.createElement)("div", {
					key: "err",
					className: "gb-error"
				}, notice));
				body = (0, react.createElement)("div", { className: "gb-list" }, [...items, ...extra]);
			}
			const newRow = (0, react.createElement)("div", { className: "gb-new" }, [(0, react.createElement)("input", {
				key: "i",
				className: "gb-input",
			...
			const foot = (0, react.createElement)("div", { className: "gb-foot" }, [(0, react.createElement)("span", {
				key: "p",
				className: "gb-path",
				title: workspacePath
			}, workspacePath), (0, react.createElement)("button", {
				key: "r",
				type: "button",
			...
			const pop = (0, react.createElement)("div", { className: "gb-pop" }, [
				head,
				newRow,
				body,
				foot
			]);
			return (0, react.createElement)("div", { className: "gb-root" }, [chip, pop]);
		}
		/**
